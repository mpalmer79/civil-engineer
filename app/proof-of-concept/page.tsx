...
// /proof-of-concept is the canonical proof URL; /poc and /proofofconcept
// permanently redirect to it in next.config.mjs.
  ...
  return (
    <div className="bg-white text-slate-900">
      ...
      >
        ...
        <BrooksideProjectVisual variant="proof" className="mt-6 max-w-3xl" />
