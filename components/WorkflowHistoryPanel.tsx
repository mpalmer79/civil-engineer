...
// A chronological list of reviewer actions recorded on a workflow item. This is
  ...
  if (actions.length === 0) {
    return (
      <div className="surface-card p-6 text-sm text-slate-500">
        No reviewer actions recorded for this item yet.
      </div>
    );
  }
  return (
    <div className="surface-card p-6">
      <h3 className="text-lg font-semibold text-slate-900">Item history</h3>
