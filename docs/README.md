...
- [design/BROOKSIDE_VISUAL_SYSTEM.md](design/BROOKSIDE_VISUAL_SYSTEM.md): the Brookside conceptual aerial, its social preview derivative, placements, disclosures, and metadata configuration
