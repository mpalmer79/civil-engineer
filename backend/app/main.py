...
app = FastAPI(
    ...
    description=(
        ...
        "Phase 5 adds a persisted human review queue, reviewer action history, "
        "and evaluation scoring of AI draft findings against expected findings. "
        "No live AI calls, embeddings, or vector retrieval are included."
    ),
    version="0.5.0",
    lifespan=lifespan,
)
