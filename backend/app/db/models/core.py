"""Core review domain: projects, documents, evidence, checklists, findings,
audit events, retrieval, plan sheets, packets, workflow, response packages,
and review cycles. Further domain extraction is staged in ADR 0005."""
