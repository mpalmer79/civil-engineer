...
Phase 8 review packet entities, and the Phase 9 reviewer workflow board
entities. JSON columns are used for arrays and nested values during the local
prototype phase, with a clean path to normalization later.
"""
